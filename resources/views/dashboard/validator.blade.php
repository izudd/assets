<x-app-layout>
    ...
    <div class="w-full max-w-lg bg-white rounded-2xl shadow-lg p-8">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">
            Form <span class="text-blue-600">Validator</span>
        </h2>
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('validator.store') }}" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="role" value="validator" readonly
